...
contract Yakyuken is ERC721B, ERC721URIStorage, Ownable {
    ...
    function initializeMetadata(bytes calldata metadata_, bytes7 sampleImageTraits_) external onlyOwner initialize(0) {
    ...
    function _getTraitFromMask(bytes7 mask_, uint8 pos_, uint8 shift_, uint256 max_)
        internal
        pure
        returns (uint8 trait_)
    {
