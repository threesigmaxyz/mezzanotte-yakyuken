...
An implementation for on-chain NFTs
...
After installing this branch, run with "make anvil" and then "made deploy-anvil" to check the deployment costs in this implementation without improvements
